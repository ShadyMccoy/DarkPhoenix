...
| 08 | [Inflection-point grid](08-inflection-grid.md) | ~130 cells; BOT LEVEL ratcheted (current reds, 2026-07-28 full runs: plan-t4-link-haul-pricing — the remaining bisected #143 master regression; the batch-load-marginal refill-SLA class — spec 34 open item; exp-t5-founding timeout — PARKED (owner 2026-07-28, out of the current program's scope). haul-t3-dedicated-resume-groundpile RESOLVED 2026-07-28 — staging gap, deterministic green since; the earned-reservation redesign was attempted and reverted the same day, measurements in spec 34) | ongoing — the success metric |
