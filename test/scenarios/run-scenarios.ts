...
/**
 * Scenario Planner Test Runner
 *
 * Run planning scenarios from JSON configuration files to iterate on
 * the ChainPlanner algorithm.
 *
 * Usage:
 *   npx ts-node test/scenarios/run-scenarios.ts              # Run all scenarios
 *   npx ts-node test/scenarios/run-scenarios.ts single       # Run scenarios matching "single"
 *   npx ts-node test/scenarios/run-scenarios.ts --verbose    # Verbose output
 *   npx ts-node test/scenarios/run-scenarios.ts --list       # List available scenarios
 */
...
function listScenarios(scenarios: Scenario[]): void {
  console.log("");
  console.log(colorize("Available Scenarios:", "bright"));
  console.log("");
...
function runScenarios(
  ...
  console.log("");
  console.log(colorize("Running Scenarios...", "bright"));
  console.log("");
