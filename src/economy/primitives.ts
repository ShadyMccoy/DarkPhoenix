...
// retired planning/EconomicConstants; phase G deleted those modules'
// transitional re-exports, so every consumer imports from here directly).
// ---------------------------------------------------------------------------
 ...
 * body (RESERVER_PARTS_PER_ROOM = 4), while RESERVER_BODY_COST (650, below)
 * deliberately prices the MINIMUM viable 1 CLAIM + 1 MOVE body - the
 * couldReserve affordability floor in IncrementalAnalysis.
 */
export const RESERVER_DUTY = 0.5;

// ---------------------------------------------------------------------------
// Reserving a remote room (homed here from corps/economics - the last four
// economic constants stranded in the EXECUTE directory after spec 35 phase B).
// ---------------------------------------------------------------------------
