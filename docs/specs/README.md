...
| 32 | [Strategic-seam refactor](32-strategic-seam-refactor.md) | PHASES A–D LANDED 2026-07-27 (dead-code sweep −3,295 lines; primitives owns its constants, EconomicConstants deleted; economy/ids.ts + censusLens id lenses; propose helpers, optional run, INFRA_ROLES killed, demandLadder, SpawnAnchoredCorp, regimes lens home) — open: D-scout, E structural regimes, F legacy-pair port, G flow collapse, H giant splits | P0 |
